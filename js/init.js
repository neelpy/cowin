...
function notify(msg, ava){
  if (ava == true) {
    
    $nofity.success(msg, {durations: {success: 4500}})
  }
  else if(ava == null){
    $nofity.info(msg,{durations:{info:0}})
  }
  else{
    $nofity.warning(msg, {durations: {warning: 4500}})
  }
